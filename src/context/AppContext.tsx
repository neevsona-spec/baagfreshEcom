...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const [orders, setOrders] = useState<Order[]>([
    {
      id: 'ord-bf-8942',
      orderNumber: 'BF-89420-VRN',
      date: 'Yesterday, 04:30 PM',
      items: [
        {
          id: 'bf-kashmiri-saffron-1g Vial',
          product: PRODUCTS[2],
          selectedWeight: '1g Vial',
          price: 420,
          originalPrice: 550,
          quantity: 2,
        },
        {
          id: 'bf-jumbo-cashews-500g',
          product: PRODUCTS[1],
          selectedWeight: '500g',
          price: 980,
          originalPrice: 1300,
      ...
      trackingSteps: [
        { title: 'Order Confirmed & Verified', description: 'Payment verified via UPI (Ref #982410)', date: 'Yesterday 04:32 PM', completed: true },
        { title: 'Vacuum-Packed & Nitrogen Flushed', description: 'Freshly sealed at Varanasi central packing center', date: 'Yesterday 08:15 PM', completed: true },
        { title: 'Dispatched via Express Courier', description: 'Handed over to BlueDart Air Express Hub', date: 'Today 06:45 AM', completed: true },
        { title: 'Out for Delivery', description: 'Courier partner (Suresh Verma) out with your parcel', date: 'Today 11:20 AM', completed: true, current: true },
        { title: 'Delivered', description: 'Handover at doorstep with OTP verification', date: 'Estimated 06:00 PM', completed: false },
      ]
    },
    {
      id: 'ord-bf-8943',
      orderNumber: 'BF-77312-VRN',
      date: '2 Days ago',
      items: [
        {
          id: 'bf-royal-heritage-box-Grand Trunk',
          product: PRODUCTS[10],
          selectedWeight: 'Grand Trunk (1.6kg)',
          price: 3450,
          originalPrice: 4200,
          quantity: 1,
        }
      ...
      shippingAddress: {
        ...
        street: '14 Civil Lines, Near Circuit House',
        apartment: 'Villa #2',
        city: 'Varanasi',
        state: 'Uttar Pradesh',
        pincode: '221002',
      ...
      eta: 'Delivered',
      trackingSteps: [
        { title: 'Order Confirmed', description: 'Payment captured securely via Card', date: '15 Aug 10:30 AM', completed: true },
        { title: 'Packed in Brass Trunk', description: 'Velvet wrapped & sealed', date: '15 Aug 02:00 PM', completed: true },
        { title: 'Dispatched', description: 'Express Varanasi Transit', date: '15 Aug 05:00 PM', completed: true },
        { title: 'Out for Delivery', description: 'Driver assigned', date: '16 Aug 09:00 AM', completed: true },
        { title: 'Delivered Successfully', description: 'Delivered to recipient with digital signature', date: '16 Aug 12:45 PM', completed: true },
      ]
    }
  ]);
